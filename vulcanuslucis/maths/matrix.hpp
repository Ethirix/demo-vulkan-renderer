#ifndef VULCANUSLUCIS_MATRIX_HPP
#define VULCANUSLUCIS_MATRIX_HPP
...
namespace maths
{
    ...
    private:
        ...
        [[nodiscard]] constexpr std::array<std::array<Type, Columns - 1>, Rows - 1> get_minor(std::size_t x) const;
...
#include <vulcanuslucis/maths/matrix.ipp>
